...
if("TRUE" STREQUAL "TRUE")
  set(android_core_SOURCE_PREFIX /home/williamhuang/android_core/src/android_core)
  set(android_core_DEVEL_PREFIX /home/williamhuang/android_core/devel)
  ...
  set(android_core_INSTALL_PREFIX /home/williamhuang/android_core/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'android_core' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Daniel Stonier <d.stonier@gmail.com>, Damon Kohler <damonkohler@google.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'android_core' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/williamhuang/android_core/src/android_core/${idir}'.  Ask the maintainer 'Daniel Stonier <d.stonier@gmail.com>, Damon Kohler <damonkohler@google.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/williamhuang/android_core/devel/lib;/home/williamhuang/catkin_ws/devel/lib;/opt/ros/indigo/lib)
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${android_core_dep}_FOUND)
      find_package(${android_core_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${android_core_dep} REQUIRED ${depend_list})
  endif()
